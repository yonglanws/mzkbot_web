...
- [用户数据管理](./sakura/user-data) — 绑定账号、设置权限
- [高阶数据分析](./sakura/advanced) — 需要上传数据的分析功能
- [智能卡组推荐](./sakura/deck) — 基于卡牌数据的卡组推荐
- [查询与工具箱](./sakura/tools) — 活动查询、歌曲查询、卡牌查询等

## 快速开始

1. **新手入门** — 了解 [基础对话](./basic/chat) 和 [每日签到](./basic/signin)
2. **娱乐功能** — 体验 [PJSK 猜歌](./entertainment/guess-song) 等小游戏
3. **游戏助手** — 使用 SakuraBOT 专项功能查询游戏数据