...
<div style="display: flex; align-items: center; background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%); padding: 20px; border-radius: 12px; margin: 20px 0; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
  ...
  <div>
    ...
    <a href="https://github.com/yonglanws" style="color: #0366d6; text-decoration: none; font-size: 0.85rem; margin-top: 5px; display: inline-block;">
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 24px; margin-top: 20px;">
  ...
  <div style="background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%); border: 1px solid #eaeaea; border-radius: 12px; padding: 24px; box-shadow: 0 4px 6px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
    <div style="display: flex; align-items: center; margin-bottom: 12px;">
      ...
      <h3 style="margin: 0; font-size: 1.25rem; color: #333;">Napcat</h3>
    </div>
  ...
  <div style="background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%); border: 1px solid #eaeaea; border-radius: 12px; padding: 24px; box-shadow: 0 4px 6px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
    <div style="display: flex; align-items: center; margin-bottom: 12px;">
      <span style="font-size: 24px; margin-right: 12px;">🧠</span>
      <h3 style="margin: 0; font-size: 1.25rem; color: #333;">Astrbot</h3>
    </div>
    <p style="color: #666; line-height: 1.6; margin: 0; font-size: 0.95rem;">
  ...
  <div style="background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%); border: 1px solid #eaeaea; border-radius: 12px; padding: 24px; box-shadow: 0 4px 6px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
    <div style="display: flex; align-items: center; margin-bottom: 12px;">
      <span style="font-size: 24px; margin-right: 12px;">🎵</span>
      <h3 style="margin: 0; font-size: 1.25rem; color: #333;">HarukiBot</h3>
    </div>
    <p style="color: #666; line-height: 1.6; margin: 0; font-size: 0.95rem;">
