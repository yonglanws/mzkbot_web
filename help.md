...
- **分数**：`@mzkbot 猜曲绘分数`
- **排行榜**：`@mzkbot 猜曲绘排行榜`
- **排行榜自定义名称**：`@mzkbot 猜曲绘自定义名称 自定义名称`

<div align="center">
  <img src="/image/qh.png" alt="猜曲绘演示" width="45%" style="margin: 5px; border-radius: 8px;"/>
</div>
...
- **分数**：`@mzkbot 歌词猜曲分数`
- **排行榜**：`@mzkbot 歌词猜曲排行榜`
- **排行榜自定义名称**：`@mzkbot 歌词猜曲自定义名称 自定义名称`

<div align="center">
  <img src="/image/gccq.jpg" alt="歌词猜曲演示" width="45%" style="margin: 5px; border-radius: 8px;"/>
</div>
...
| `pjskdetail` | 获取详细信息 (金币/水晶/家具/每日挑战等)  *介意隐私者可私聊查询*  |
...
| 指令     | 用法示例                   | 说明                                      |
| :----- | :--------------------- | :-------------------------------------- |
| `组卡`   | `组卡 ln 橙`              | 指定箱活最佳卡组 Top7  参数：`[队名] [属性]`           |
| `活动组卡` | `活动组卡 龙 hard`          | 当前活动最佳卡组 Top7  默认歌曲：独りんぼエンヴィー           |
| `挑战组卡` | `挑战组卡 ick 10th master` | 每日挑战最佳卡组 Top7  参数：`[角色] [歌曲] [难度]`      |
| `最强组卡` | `最强组卡`                 | 同色同队理论最高分卡组 Top7  默认歌曲：Expert 独りんぼエンヴィー |
